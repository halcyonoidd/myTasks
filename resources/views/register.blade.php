...
<body class="bg-gray-900 flex items-center justify-center min-h-screen">
    <div class="bg-gray-200 p-16 rounded shadow-md w-full max-w-6xl">
        <div class="flex items-stretch gap-6">
            ...
            @endif
                <h1 class="text-gray-900 text-4xl font-bold mb-4">Register</h1>
                <p class="text-gray-900 mb-6">Create a new account to manage your tasks.</p>
                <form method="POST" action="{{ route('register.post') }}">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-gray-900 mb-2" for="name">Name</label>
                    ...
                    <div class="mb-6">
                        <label class="block text-gray-900 mb-2" for="password_confirmation">Confirm Password</label>
