...
<div class="min-h-screen bg-gradient-to-br bg-gray-900 text-slate-800">
    <div class="flex min-h-screen">
        <aside class="hidden lg:flex w-72 flex-col bg-gray-200 shadow-2xl border-r border-slate-200 transform transition duration-300" style="animation: sidebarSlideIn 0.45s ease-out;">
            <div class="py-8 space-y-6 h-full flex flex-col">
                <!-- User Profile Card -->
                <div class="px-6">
        ...
        <main class="flex-1 bg-white/90 text-slate-900">
